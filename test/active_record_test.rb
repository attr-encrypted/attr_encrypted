...
class ActiveRecordTest < Minitest::Test
  ...
  def skip test_should_create_was_predicate
  ...
  def skip test_attribute_was_works_when_options_for_old_encrypted_value_are_different_than_options_for_new_encrypted_value
    pw = 'password'
