...
* Merge updates from upstream (<https://github.com/attr-encrypted/attr_encrypted>)
...
* Forked from upstream (<https://github.com/attr-encrypted/attr_encrypted>) and rebranded
